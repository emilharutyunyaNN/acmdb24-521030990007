...
public class BTreeUtility {
   ...
   */
  public static ArrayList<BTreeEntry> generateRandomEntries(int numKeys, int tableid,
  ...
  public static int getNumTuplesPerPage(int columns) {
    ...
    int tuplesPerPage =
        (BufferPool.getPageSize() * 8 - 3 * BTreeLeafPage.INDEX_SIZE * 8) / (bytesPerTuple + 1);
  ...
  public static int getNumEntriesPerPage() {
    ...
    int entriesPerPage =
        (BufferPool.getPageSize() * 8 - internalpointerbytes * 8 - 1) / (nentrybytes * 8
